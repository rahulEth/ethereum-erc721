...
contract TestToken is ERC721Token , CappedToken, BurnablePausableToken {
   
   bytes4 private constant _InterfaceId_ERC165 = 0x01ffc9a7;
    constructor()
        public
        payable
        ERC721Token('Avengers', 'AVG')
        CappedToken(1000)
    {
        owner = msg.sender;
    }
    ...
    function setTokenURI(uint256 _tokenId, string _uri) public //external onlyOwnerOf(_tokenId)
    {
        super._setTokenURI(_tokenId, _uri);
    }
}
